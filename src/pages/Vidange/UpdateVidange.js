...
import { getById, getAllhuiles, getAllVehicules, updatevidange } from './service/Service';
...
function UpdateVidange() {
    ...
    const handleSubmit = async() =>{
        const result = await updatevidange(vidange)
        if(result == true){
            setmessage("vidange actuel est modifiee")
    ...
    const getbyId = async () =>{
        const myvidange = await getById(id)
        setvidange({
            ...vidange,
              ...myvidange
        })
    ...
    return (
        ...
        <div className="page-content">
            <Breadcrumbs title="Modification" breadcrumbItem="Les Vidanges" />
                        ...
                        <AvForm className="needs-validation" onValidSubmit={handleSubmit}>
                            <Row>
                                <Col md="4">
                                    ...
                                    <Select
                                    value={selectedVehicule!==null ? selectedVehicule : {label : vidange.vehicule.immatriculation, value : vidange.vehicule.id}}
                                    onChange={
                                ...
                                <Col md="4">
                                    <div className="mb-3">
                                        ...
                                        <Select
                                            value={ selectedhuile!==null ? selectedhuile : {label : vidange.huile.nom, value : vidange.huile.id}}
                                            onChange={
                                                handleSelecthuile
                                            }
                                            options={optionhuile}
                                ...
                                <Col md="4">
                                    ...
                                    <AvField
                                            name="quantiteHuile"
                                            placeholder="quantite Huile"
                                            huile="text"
                                            value={vidange.quantiteHuile}
                                            onChange={handleChange}
                                            errorMessage=" Entrer quantite Huile."
